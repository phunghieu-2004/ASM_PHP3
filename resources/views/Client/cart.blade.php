      ...
      <div class="shopping-cart">
        <div class="cart-table__wrapper">
              ...
              <tr>
                <td>
                  <div class="shopping-cart__product-item">
                    <a href="product1_simple.html">
                      <img loading="lazy" src="{{ asset('theme/assets/client/images/cart-item-1.jpg') }}" width="120" height="120" alt="">
                      {{-- {{asset(storege/image)}}/{{$value['image']}} --}}
                    </a>
                  </div>
                </td>
                <td>
                  <div class="shopping-cart__product-item__detail">
                    <h4><a href="product1_simple.html">{{$value['name']}}</a></h4>
                ...
                <td>
                  <div class="qty-control position-relative">
                    <input type="number" name="quantity" value="{{$value['quantity']}}" min="1" class="qty-control__number text-center">
                    <div class="qty-control__reduce">-</div>
                    <div class="qty-control__increase">+</div>
                  </div><!-- .qty-control -->
                </td>
                <td>
                  <span class="shopping-cart__subtotal">${{$value['price'] * $value['quantity']}}</span>
                </td>
                <td>
          ...
          <div class="cart-table-footer">
            <form action="https://uomo-html.flexkitux.com/Demo11/" class="position-relative bg-body">
